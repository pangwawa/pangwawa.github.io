---
title: "深入理解Java虚拟机——JVM的GC详解"
tags: ["JVM", "GC","Java"]
author: "Jack Wu"
date: 2019-01-06T09:31:57+08:00
draft: false
---
## JVM的GC有哪些
#### 一、Serial收集器(jdk1.3)
...
#### 七、G1收集器 （JDK 7u4推出，JDK 9 设置为默认收集器）
